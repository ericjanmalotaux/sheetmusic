...
>> and <<BrusBR9126>>,
done primarily as an excercise to learn Lilypond. Also I was not happy with any of the versions found on https://www.cpdl.org/wiki/index.php/Gaude_Virgo,_Mater_Christi_(Josquin_des_Prez)[CPDL], and with <<NJE>>. The <<NJE>> of course does have the advantage that any additions from the editor are clearly distinguished as such.
